...
import { createMap, deleteMap, deleteMarker, editEditors, getEditors, getMarkers, selectMap, updateMap } from '../map/contollers';
...
router.put('/editors', requireAuth, editEditors);
